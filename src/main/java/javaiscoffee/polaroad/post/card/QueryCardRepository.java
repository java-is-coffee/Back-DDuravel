...
public interface QueryCardRepository {
    ...
    List<MapCardListDto> getMapCardListByHashtag(Long hashtagId, PostConcept concept, CardStatus status, double swLatitude, double neLatitude, double swLongitude, double neLongitude, int pageSize);
}
