...
//        String message = ex.getParameterName() + "값이 존재하지 않습니다.";
    ...
    public ResponseEntity<Object> handleEOFException(IllegalStateException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(ResponseMessages.SESSION_CLOSED);
    }

    // 다른 예외 유형을 처리하는 핸들러를 추가할 수 있습니다.
    @ExceptionHandler(NotFoundException.class)
    public ResponseEntity<Object> handleMemberNotFoundException(NotFoundException ex) {
